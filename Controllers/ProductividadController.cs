...
namespace TransportationCore.Controllers
{
    ...
    public class ProductividadController : ControllerBase
    {
        ...
        public ProductividadController(ApplicationDbContext context, IMapper mapper, ISoftDeleteService softDeleteService)
        {
            _context = context;
            this.mapper = mapper;
            _context.UserEmail = "";
        ...
        [HttpGet("{IdPlanificacion},{IdOperador}")]
        ...
        [HttpGet("{IdPlanificacion}", Name = "GetResumenProductividad")]
        public async Task<ActionResult<ProductividadConsultaDetalleDto>> GetResumenProductividad(decimal IdPlanificacion)
        {
            string parametro = $" @IdPlanificacion = {IdPlanificacion}";
